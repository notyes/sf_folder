...
CDStorage.prototype = {
    ...
    _handleMessage: function(event){
        if(event.origin == this._origin){
            ...
            if(typeof this._requests[data.id] !='undefined' && typeof this._requests[data.id].deferred != 'undefined'){
                this._requests[data.id].deferred.resolve(data.value);
            }
            if(typeof this._requests[data.id] !='undefined' && typeof this._requests[data.id].callback == 'function'){
