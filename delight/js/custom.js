...
var setGoogleMapMarkers = function(map) {
  var markers = [],
      image = {
        url: 'img/delight/map-icon.png',
        // This marker is 20 pixels wide by 32 pixels tall.
        size: new google.maps.Size(23, 115),
        // The origin for this image is 0,0.
        origin: new google.maps.Point(0,0),
        // The anchor for this image is the base of the flagpole at 0,32.
        anchor: new google.maps.Point(0, 115)
      };
...
$(document).ready(function() {
  if ($('.cover-image .bx-wrapper .bx-has-pager').length) {
    $('.cover-image').addClass('hasSlider')
  }
});