 ...
 !function ($){
  ...
  pixelPlot.prototype = {
    ...
    buyableEvent: function buyableEvent(e){
      ...
      {
          $('.home-spec-container-wrapper').css('height', min_h+230);
          $('.buyable-container').css('height', min_h+220);
      }else{
      */
          $('.home-spec-container-wrapper').css('height', min_h+10);
...
!function($){
  $('.home-specification').on('click', '#home-specification-thumb .gallery-list-item a', function(e){
    e.preventDefault();
  ...
  $('#home-specification-thumb .gallery-list-item a:first').click();
}(jQuery);
